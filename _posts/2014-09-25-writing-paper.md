...
byline: My methodology to defeat writer's block, and avoid extensive rewriting!
---

I must make a confession. Through no one's fault bu my own, I made it through
...
the wrong idea, this is not about *what* to write, or whether or not your
...
me, and it is easy to do.

Whenever I have a chance, I tell a variation of the following to students:
...
opening a code editor". These are the *last* steps. What comes before,
is the thinking and the planning. Writing the paper is the *boring* part,
because (in my opinion), it is the *obvious* part. When I follow my usual
...
writing (*patent pending*): start with an outline, tell a story, go top-down.

# Start with an outline

Your are probably disappointed at this point. Start with an outline, is that
...
narrative piece, it works. But I really do mean *start* with an outline,
...
figures where different, but at least we had an idea of where we were headed.

So the first outline is not necessarily a list of bullet points. It is a
...
the global narrative of the paper. Because, you see, I like it when papers...

# ... tell a story

And by a story, I don't mean the particular story of how I came from the
...
the paper, and so we ended up telling a different story.

What I mean is that a paper needs to have a plot: expose the initial situation
(*We have this theory about A, and it's working well at predicting this and
this, and here are the core mechanisms*), then introduce a perturbation
(*But you see, there is dataset D, and it contradicts the predictions
made under the relevant theory*). This is what I write first, and this is
usually the introduction. Then, write the dénouement (*In fact, mechanisms
B and C interact in this weird way under particular circumustances, so you
need to account that.*). This is the plot (also the first paragraph of the
...
Let's get back to the outline. At this point, the context is defined, the
...
within one, active voice, declarative sentence (*Coexistence happens under
source-sink dynamics at intermediate dispersal levels*). This is the summary
...
paragraph into three sub-points, especially if it is a key paragraph.

I think that this method has important advantages. First, because I write the
...
paragraphs reads *Ponder on semi-related litterature from sub-field you
enjoy despite never having worked in it* (one of my biases), then I can
...
Once I have the outline, that I have made sure that the story flows and
there are no gaps in the story, and that the paragraphs are balanced, it's
time to start writing.

This is as good a place as any to mention that all of the above takes place
...
paragraph cuts the flow. I would have removed it from the outline.

Anyways. When it's time to start writing -- on a computer, I can start
...
end. Everything in the paragraph needs to help the "story" move forward.

The other advantage (and it has became a selling point over the last few
...
down. So I don't say *I have to write that paper*. I say, *I have to write 300
words about how this statistical bias affects the computational efficiency
of null models*. This is much less daunting. Writing 300 words is nothing,
especially when you already know the big story.

# Parting words

So here is my method -- if you want to make your life easier when writing a
...
has been done, then the actual writing is a matter of connecting the dots.

I have also noticed that it made me writer shorter, thighter papers. Probably
...
is *entirely* about me trying to cope with my terrible habits). If found
...
than under my previous strategy (write 15000 words and cut).

I'm not pretending that this method will work for you -- or that I follow
...
easier to read and follow for the readers.
